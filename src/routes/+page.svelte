...
<style lang="scss" type="text/scss">
    ...
    <section class="searchStatus"><cite>Total results: {JSON.stringify(answerCount[0].result[0].count)}</cite></section>
